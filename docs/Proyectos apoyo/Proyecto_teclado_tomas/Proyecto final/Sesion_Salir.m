%
% Programa 'sesion_salir.m': 
%
%   Es un programa auxiliar para el programa Panel.m. Se encarga de gestionar la salida del programa 
%
%
...
MsgHandle=uicontrol(figs(2), Font, ...
                   'Style','text', ...
                   'Units','pixels', ...
                   'Position',[100 100 260 18 ] , ...
                   'String',['¿Está seguro que desea salir de la aplicación?'], ...
                   'FontSize',12,...     
                   'Tag','MessageBox' , ...
...
AccionSi = ['close all; clear all;']; %AccionSi
SiHandle=uicontrol(figs(2), Font, ...
                  ...
                  'FontSize',16,...
                  'String','Si'  , ...
                  'TooltipString', 'Saldra de la aplicación y se cerraran todas las ventanas', ...
                  'HorizontalAlignment','center'   , ...
                  'Tag','SiButton');
