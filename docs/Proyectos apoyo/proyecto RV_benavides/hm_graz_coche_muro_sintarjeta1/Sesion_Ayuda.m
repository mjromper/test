...
mensaje0=[...
        ...
        '                                                  '...
        'Alumno: Francisco Benavides Martín                ';...
        '                                                  '...
        '                                                  ';...
        '                                                  '...
        '                                                  ';...
        ...
        '                                                  '];
mensaje1=[...
        'Este programa sirve para organizar sesiones, para '... 
        'ello ayuda a configurar totalmente un ensayo y    ';...
...
mensaje2=[...
        ...
        '                                                  '...
        '                                                  '];
mensaje=[mensaje0 mensaje1 mensaje2]; 
...
Accion_anterior= [...
        ...
        '',...                                    
        'ayuda = ayuda -1;',... 
        'if ayuda==0, ayuda=length(mensaje)/100; end;',...
...
Accion_siguiente= [...
        ...
        '',...                                    
        'ayuda = ayuda +1;',... 
        'if ayuda==length(mensaje)/100+1, ayuda=1; end;',...
        'set(popup_ayuda,''Value'',ayuda);',...
        'set(textHndl_mensaje,''String'',mensaje(:,(ayuda-1)*100+1:ayuda*100));',...
    ]; 
