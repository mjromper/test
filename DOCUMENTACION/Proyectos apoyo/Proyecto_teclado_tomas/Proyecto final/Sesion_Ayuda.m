...
set(figs(8), ...
	'NumberTitle','off', ...
	'Name','Editor de Texto controlado por señales EEG - Ayuda de Sesión', ...
	'Resize','off', ...
	'MenuBar','none', ...
	'Units','cent', ...
	'Position',[5 2 17.1 9], ...
...
'                                                                                                    ';...%linea siguiente
'                                                                                                    ';...        
'                          PROCESADOR DE TEXTO CONTROLADO POR SEÑALES EEG                            ';...
'                                                                                                    ';...
'                             Escuela Técnica Superior de Ingenieros de Telecomunicación             ';...
'                                        Departamento  de Tecnología Electrónica 2007                ';...
'                                                       Universidad de Málaga                        ';...        
'                                                                                                    ';...
'                                            Profesor tutor: Ricardo Ron Angevín                     ';...
'                                                Alumno: Tomás Pérez Lisbona                         ';...
'                                                                                                    '];
mensaje1=[...
'     El usuario debe configurar la aplicación con los siguientes parámetros personales:             ';...%linea siguiente
'                                                                                                    ';...
' -Fc.Inf y Fc.Sup: Son las frecuencias de corte inferior y superior. Se usan para diseñar el filtro.';...
' -F.Der y F.Izq: Factor multiplicativo derecha e izquierda. Adaptan los valores del usuario a los   ';...
'que necesita la aplicación para su funcionamiento correcto.                                         ';...
' -w0, w1 y w2: Son unos pesos obtenidos previamente por LDA que necesita el clasificador de señales.';...
' -Umbral del usuario: Valor personal por el que se multiplica D’ para adaptar el tamaño de la barra.';...
' -T.Pausa: Tiempo que transcurre entre que se ha realizado un evento y un nuevo proceso de selección';...
' -Velocidad de rotación: Velocidad con la que se desplaza de la flecha. Se va a medir en grados.    ';...
' -T. de selección: Tiempo que el usuario debe permanecer dentro de un bloque para que se seleccione.';...
'                                                                                                    '];
mensaje2=[...
'      El método para seleccionar las letras del alfabeto ha sido distribuir los caracteres entre 10 ';...
' bloques situados de forma circular donde se podrán seleccionar con una flecha móvil.               ';...
'      Para selecciónar una letra, existe una flecha en el centro del círculo que apunta hacia los   ';...
...
' de tiempo establecido (T.selección), el bloque será seleccionado.                                  ';...
'      En ese momento se abrirá una nueva rueda donde solamente aparezcan las letras del bloque selec';...
'cionado. En esta rueda se realizará un proceso de selección para elegír la letra deseada.           ';...
'      Existe la opción de BORRAR una letra, la cual se podrá seleccionar en la rueda principal.     ';...
'      Una vez se haya seleccionado una letra, ésta se representará en la ventana de texto.          ';...
'                                                                                                    '];
...
popup_ayuda = uicontrol( ...
   ...
   'ForegroundColor',[0 0 0], ...
   'String','Miscelanea|Parámetros a introducir|Funcionamiento General|Salir', ...
