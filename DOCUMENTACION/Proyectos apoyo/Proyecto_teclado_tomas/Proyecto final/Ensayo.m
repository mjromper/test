...
x=0;
y=0;
a_rueda=0;              % variable para comprobar el paso de la aplicación donde estoy
selec=0;                % variable para comprobar el paso de la aplicación donde estoy
...
tiempo_en_bloq=round(tiempo_en_bloq/0.031);    %/ calculo el nº de tam para q un bloq sea seleccionado 
