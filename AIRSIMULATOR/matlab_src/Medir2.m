...
global commandTime commandTimeTot selectedOption commands explore ordenCom; 
...
%    t_invocaxRed
   ...
   comando1 = ['save ' 'ESTADISTICAS' '\estadisticos_' sujeto '_' num2str(sesion) '.mat num_vueltas t_total ' ...
       ...
       't_bloque_acierto_media t_total_acierto_media t_invocaxMedia t_invocaxGreen t_invocaxRed path numColisiones ordenCom'];
   eval(comando1);         
